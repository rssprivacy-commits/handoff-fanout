...
:func:`verify_lock` is the anti-drift enforcement: given a lock receipt and an
on-disk plan, it fails closed if the plan no longer hashes to what the owner
approved (a worker silently editing ``plan.json`` is caught here).
"""
